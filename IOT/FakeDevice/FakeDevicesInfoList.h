...
class FakeDevicesInfoList : public QAbstractListModel
{
    Q_OBJECT
public:
    FakeDevicesInfoList(QObject *parent = 0);
    enum DevicelRoles {
...
class FakeDeviceCmdList : public FakeDevicesInfoList
{
    Q_OBJECT
public:
    FakeDeviceCmdList(QObject *parent = 0);
    enum DevicelRoles {
