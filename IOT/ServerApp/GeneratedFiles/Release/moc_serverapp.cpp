...
const QMetaObject ServerApp::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ServerApp.data,
      qt_meta_data_ServerApp,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ServerApp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ServerApp.stringdata0))
        return static_cast<void*>(const_cast< ServerApp*>(this));
